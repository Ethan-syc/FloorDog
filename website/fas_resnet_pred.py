...
def men_pred(clothes_path):
    ...
    net.load_state_dict(torch.load('website/support/fas_resnet101_men_100000.pt',  map_location='cpu'))
...
def women_pred(clothes_path):
    ...
    net.load_state_dict(torch.load('website/support/fas_resnet101_women_100000.pt',  map_location='cpu'))
